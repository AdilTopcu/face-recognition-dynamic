...
KarsilastirilacakGozOrani = KarsilastirilacakGozBoyu / 
KarsilastirilacakGozEni;
...
KarsilastirilacakYuzOrani = KarsilastirilacakYuzEni / 
KarsilastirilacakYuzBoyu;
...
KarsilastirilacakBurunOrani = KarsilastirilacakBurunEni / 
KarsilastirilacakBurunBoyu;
...
KarsilastirilacakDudakOrani = KarsilastirilacakDudakBoyu / 
KarsilastirilacakDudakEni;
disp(['Dudak oranınız: ', num2str(KarsilastirilacakDudakOrani)]);



KarsilastirilacakYuzunKirmiziligi = input('Yüzünüzün RGB kırmızılık 
sayısal değerini giriniz:');
KarsilastirilacakYuzunYesilligi = input('Yüzünüzün RGB yeşillik sayısal 
değerini giriniz:');
KarsilastirilacakYuzunMaviligi = input('Yüzünüzün RGB maviliği sayısal 
değerini giriniz:');


KarsilastirilacakYuzunRengi = 
((KarsilastirilacakYuzunKirmiziligi*KarsilastirilacakYuzunYesilligi*KarsilastirilacakYuzunMaviligi)^(1/3))/256
disp(['Ten renginizin sayısallaştırılmış değeri: ', 
num2str(KarsilastirilacakYuzunRengi)]);
...
KayitlidanUzaklikMatrisi = abs(AgirlikDegeriBulmaMatrisi - 
KayitliYuzunSiniflari) 
...
farkmatrisi = 
[GozOraniFarki,YuzOraniFarki,BurunOraniFarki,DudakOraniFarki,YuzunRengiFarki]
